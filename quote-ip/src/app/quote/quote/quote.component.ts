...
export class QuoteComponent implements OnInit {
  quotes: Quote[] = [
    new Quote(1, 'Love', '"Being deeply loved by someone gives you strength, while loving someone deeply gives you courage."', 'Pinocchio', 'Woodey', new Date(2021, 11, 17), 0, 0),
    ...
    new Quote(3, 'Strenght', ' “You never know how strong you are, until being strong is your only choice”', '-Westermann Volker', '-Milka Makanda>', new Date(2022, 1, 29), 0, 0),
